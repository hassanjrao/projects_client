...
<head>
	...
	<title>Contact - Solid House</title>
</head>
<body>
	<header class="container-fluid">
		...
		<div class="row d-flex align-items-center">
			<div class="col-lg-6 col-md-12 no-padding-left no-padding-right OwHidden">
				<img src="img/map-solid-house.jpg" class=" img-project bg-page" alt="map">
			</div>
			<div class="header-text col-lg-3 col-md-12">
				...
				<p class="pd-bottom">
						Milan<br>
						Via Giuseppe Tellera 8<br>
						+39 349 733 1082<br>
						+39 349 733 1082<br>
						info@solidhouse.it<br>
				</p>
				<hr align="center" class="divider pd-bottom text-center">
				<div class="social pd-bottom">
					<a href="#"><i class="fab fa-facebook pd-right white "></i></a>
