...
<body>
	<header class="container-fluid">
			...
			<nav class="navbar navbar-expand-lg navbar-light pd-top">
			  ...
			  <div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav ml-auto">
				  ...
				  <li class="nav-item">
					<a class="nav-link" href="about-us.php">Abouts us</a>
				  </li>
				  <li class="nav-item">
		...
		<div class="row d-flex align-items-center">
			<div class="col-lg-6 col-md-12 no-padding-left no-padding-right">
				<img src="img/bg-team-page.png" class="img-project" alt="team-solid-house">
			</div>
			<div class="header-text col-lg-3 col-md-12">
				...
				<p class="pd-bottom">
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ornare orci at elit euismod, vitae vestibulum felis ullamcorper
				</p>
				<a href="#about"><button type="button" class="button-dark">Read More</button><br></a>
				</div>
			</div>
		</div>
	</header>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<img src="img/alexander.png" class="img-fluid pd-bottom" alt="avatar-1">
					<h4 style="padding-bottom: 0">Alexander Smiev</h4>
					<h6 style="padding-top: 0;" class="pd-bottom">CEO</h6>
					<hr class="divider">
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, veritatis.
					</p>
				</div>
				<div class="col-lg-4 col-md-6">
					<img src="img/alice.png" class="img-fluid pd-bottom" alt="avatar-2">
					<h4 style="padding-bottom: 0">Alexander Smiev</h4>
					<h6 style="padding-top: 0;" class="pd-bottom">CEO</h6>
					<hr class="divider">
					<p>
				...
				<div class="col-lg-4 col-md-6">
					<img src="img/anna.png" class="img-fluid pd-bottom" alt="avatar-3">
					<h4 style="padding-bottom: 0">Alexander Smiev</h4>
					<h6 style="padding-top: 0;" class="pd-bottom">CEO</h6>
					<hr class="divider">
					<p>
				...
				<div class="col-lg-4 col-md-6">
					<img src="img/alexander.png" class="img-fluid pd-bottom" alt="avatar-4">
					<h4 style="padding-bottom: 0">Alexander Smiev</h4>
					<h6 style="padding-top: 0;" class="pd-bottom">CEO</h6>
					<hr class="divider">
					<p>
				...
				<div class="col-lg-4 col-md-6">
					<img src="img/alice.png" class="img-fluid pd-bottom" alt="avatar-5">
					<h4 style="padding-bottom: 0">Alexander Smiev</h4>
					<h6 style="padding-top: 0;" class="pd-bottom">CEO</h6>
					<hr class="divider">
					<p>
				...
				<div class="col-lg-4 col-md-6">
					<img src="img/anna.png" class="img-fluid pd-bottom" alt="avatar-6">
					<h4 style="padding-bottom: 0">Alexander Smiev</h4>
					<h6 style="padding-top: 0;" class="pd-bottom">CEO</h6>
					<hr class="divider">
					<p>
	...
	<script>
		const scroll = new SmoothScroll('.header-text  a[href*="#"]', {speed:800});
	</script>
